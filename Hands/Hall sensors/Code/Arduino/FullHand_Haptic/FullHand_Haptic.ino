...
String msgName[] = {"Th_Dist_L_X", "Th_Dist_R_X", "Th_Dist_T_X", 
    ...
    "Pinky_Dist_L_X", "Pinky_Dist_R_X", "Pinky_Dist_T_X","Pinky_Prox_L_X", "Pinky_Prox_R_X", "loop_time"};

String dataCarrier[30]; //29
...
void loop() {
  ...
  if (mode==PYTHON_MODE)
  {
    dataCarrier[29]=String(millis()-time_start);
  ...
  {
    haptic_motor_value(Th_Dist_L_X,Th_Dist_R_X, HAPTIC_THUMB);
    haptic_motor_value(Idx_Dist_L_X,Idx_Dist_R_X, HAPTIC_IDX);
    haptic_motor_value(Midd_Dist_L_X,Midd_Dist_R_X, HAPTIC_MIDD);
    haptic_motor_value(Ring_Dist_L_X,Ring_Dist_R_X, HAPTIC_RING);
    haptic_motor_value(Pinky_Dist_L_X,Pinky_Dist_R_X, HAPTIC_PINKY);
  }
}
